...
public class Bloco0Service {
    ...
    public static Bloco0 getBloco(List<NotaEletronicaTo> listaNotas) {
        bloco0 = new Bloco0();
        ...
        List<CadParticipantesTO> listaParticipantes = ParticipantesService.getListaParticipantes(listaNotas);
    ...
    private static void preencherRegistro0150(List<CadParticipantesTO> listaParticipantes) {
        Registro0150 registro0150;
        for (CadParticipantesTO participante : listaParticipantes) {
            ...
            registro0150.setCod_mun(participante.getCodMun());
